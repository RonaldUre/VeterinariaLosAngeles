...
//	@Autowired
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		if (authentication != null) {
			logger.info("El usuario autenticado es: " + authentication.getName());
		...
		if (auth != null) {
			logger.info("Utilizando la forma estatica El usuario autenticado es: " + auth.getName());
		...
		model.addAttribute("titulo", "Lista de clientes");// messageSource.getMessage("text.cliente.listar.titulo",
															// null, locale));
	...
	private boolean hasRole(String role) {
		...
		// return authorities.contains(new SimpleGrantedAuthority("role")); // otra
		// forma de validar
